...
/**
 * Class that performs the exchange action
 * Created by:
...
public class ExchangeAction extends Action {
    ...
    /**
     * The Actor that will perform the exchange action
     */
     ...
     */
    public ExchangeAction(Actor target, String direction) {
        this.target = target;
    ...
    public String execute(Actor actor, GameMap map) {
        if (actor.hasCapability(Status.HOSTILE_TO_ENEMY) && !(actor.hasCapability(Status.HOSTILE_CREATURE))) {
            ...
            System.out.println("5. Axe of Godrick\n6. Grafted Dragon");

...
/***
 * The Slam Attack Action class represents unique slam area attack carried out by some enemies.
...
public class SlamAttackAction extends Action{
    ...
    /***
     * Carries out slam area attack , meaning an attack for every exit
     * If there is target at the exit, attempt attack and do damage if hit.
     * Death action of target is called if target turns unconscious.
